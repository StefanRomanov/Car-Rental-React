...
export default (props) => {
    return <div className="container">
        <div className="clearfix col-lg-12 m-5 align-self-center">
            <div className="row">
                <div className="col-md app-bg-fourth rounded shadow">
                    <div className="m-3">
                        <h1>{props.data.brand} {props.model}</h1>
        ...
        <div className="row justify-content-center my-3">
            <Link className="btn btn-info mx-3 text-white w-25" to={"/cars/edit/" + props.data.id}>Edit</Link>
            <Link className="btn btn-danger mx-3 text-white w-25"
                  to={"/cars/delete/" + props.data.id}>Delete</Link>
        </div>
    </div>
}